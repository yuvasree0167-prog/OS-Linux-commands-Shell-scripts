...
![Alt text](<img/sed -n -e '3p' file23.png>)
...
![Alt text](<img/seq 10 | sed -n '4,6p'.png>)
...
![Alt text](<img/cat herecheck.txt.png>)
...
![Alt text](<img/awk -f nc.awk data.dat.png>)
